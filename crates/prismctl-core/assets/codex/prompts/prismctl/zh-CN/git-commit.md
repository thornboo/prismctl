...
# examples:
#   - /prompts:git-commit                           # 分析当前改动，生成提交信息
#   - /prompts:git-commit --all                     # 暂存所有改动并提交
#   - /prompts:git-commit --no-verify               # 跳过 Git 钩子检查
#   - /prompts:git-commit --emoji                   # 在提交信息中包含 emoji
#   - /prompts:git-commit --scope ui --type feat    # 指定作用域和类型
#   - /prompts:git-commit --amend --signoff         # 修补上次提交并签名
---
