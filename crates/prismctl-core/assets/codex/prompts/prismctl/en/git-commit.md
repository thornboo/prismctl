...
# examples:
#   - /prompts:git-commit                           # Analyze current changes, generate commit message
#   - /prompts:git-commit --all                     # Stage all changes and commit
#   - /prompts:git-commit --no-verify               # Skip Git hooks
#   - /prompts:git-commit --emoji                   # Include emoji in commit message
#   - /prompts:git-commit --scope ui --type feat    # Specify scope and type
#   - /prompts:git-commit --amend --signoff         # Amend last commit with signature
---

# Codex Prompt: Commit (Git-only)
...
```bash
/prompts:git-commit
/prompts:git-commit --no-verify
/prompts:git-commit --emoji
/prompts:git-commit --all --signoff
/prompts:git-commit --amend
/prompts:git-commit --scope ui --type feat --emoji
```
