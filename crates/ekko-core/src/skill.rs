...
fn claude_skills_root(home: &EkkoHome) -> PathBuf {
...
mod tests {
    ...
    fn unique_home() -> PathBuf {
        let nanos = SystemTime::now()
            ...
            .expect("time")
            .as_nanos();
        std::env::temp_dir().join(format!("ekko-skill-home-{}", nanos))
    }
    ...
    fn install_skill_writes_into_claude_skills_dir() {
        ...
        let home = EkkoHome::discover(Some(home_dir.clone())).expect("home");
