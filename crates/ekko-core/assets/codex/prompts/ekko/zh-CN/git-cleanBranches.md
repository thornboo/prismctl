...
# examples:
#   - /prompts:git-cleanBranches --dry-run
#   - /prompts:git-cleanBranches --base release/v2.1 --stale 90
#   - /prompts:git-cleanBranches --remote --yes
---

# Codex Prompt: Clean Branches
...
/prompts:git-cleanBranches --stale 90

# 清理已合并到 release/v2.1 的本地与远程分支 (自动确认)
/prompts:git-cleanBranches --base release/v2.1 --remote --yes

# [危险] 强制删除一个未合并的本地分支
/prompts:git-cleanBranches --force outdated-feature
```
