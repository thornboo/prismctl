...
fn switch_language() -> Result<(), String> {
    ...
    let default = match ekko_i18n::current_locale() {
        ekko_i18n::Locale::ZhCN => 0,
        ekko_i18n::Locale::En => 1,
    };
    let choice = prompt_select(
        &title,
    ...
    let locale = match choice {
        LangItem::ZhCN => ekko_i18n::Locale::ZhCN,
        LangItem::En => ekko_i18n::Locale::En,
